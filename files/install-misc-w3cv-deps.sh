...
if [[ ! -f /opt/front-end-is-good ]]; then
   ...
   /bin/tar zxvf validator.tar.gz && \ 
   /bin/tar zxvf sgml-lib.tar.gz && \ 
   ...
   mv httpd/conf/httpd.conf /etc/httpd/conf.d/validator.conf  # this makes it do you can browse http://yourdomain.com/w3c-validator/ 
